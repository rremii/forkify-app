...
var _paginatorView = require("./views/paginatorView");
var _paginatorViewDefault = parcelHelpers.interopDefault(_paginatorView);
...
const controlRecipes = async ()=>{
    try {
        ...
        _recipeViewDefault.default.renderError(`there was some mistake: ${err}`);
    }
};
const controlSearchResults = async ()=>{
    try {
        ...
        _resultViewDefault.default.render(_model.getSearchResultsPage(1));
        _paginatorViewDefault.default.render(_model.state.search);
    } catch (err) {
        _recipeViewDefault.default.renderError(`there was some mistake: ${err}`);
    }
};
...
const controlAddRecipe = async (newRecipe)=>{
    try {
        ...
        console.log(err);
        _addRecipeViewDefault.default.renderError(err);
    }
};
const init = ()=>{
    _bookmarkViewDefault.default.addHandlerRender(controlBookmarks);
    _recipeViewDefault.default.addHandlerHender(controlRecipes);
    ...
    _paginatorViewDefault.default.addHandlerClick(controlPagination);
    _addRecipeViewDefault.default.addHandlerUpload(controlAddRecipe);
};
init();

},{"./model":"6Yfb5","./views/recipeView":"9q0mt","./views/searchView":"51HTZ","./views/resultView":"dmYXU","core-js/stable":"eIyVg","regenerator-runtime/runtime":"cH8Iq","./views/paginatorView":"3ieXC","./views/bookmarkView":"1r5Cz","./views/addRecipeView":"4NyJt","./config":"beA2m","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"6Yfb5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const KEY = '6d725ea1-132e-406c-86ab-4338471e34f4';
...
const AJAX = async (url, uploadData)=>{
    try {
        let fetchPro = uploadData ? fetch(url, {
            method: 'POST',
            headers: {
...
},{"url:../../img/icons.svg":"iwCpK","./View":"8rtS4","fraction.js":"1JPao","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"iwCpK":[function(require,module,exports) {
...
},{"url:../../img/icons.svg":"iwCpK","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"1JPao":[function(require,module,exports) {
/**
...
},{"./View":"8rtS4","url:../../img/icons.svg":"iwCpK","./previewView":"knRyY","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"knRyY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"../internals/fails":"byxLb","../internals/object-create":"eYZeq","../internals/object-get-prototype-of":"4Xd6L","../internals/create-non-enumerable-property":"73EkF","../internals/well-known-symbol":"6sZ59","../internals/is-pure":"dlbEd"}],"fcdvD":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
var IndexedObject = require('../internals/indexed-object');
var toIndexedObject = require('../internals/to-indexed-object');
...
},{"../internals/export":"2mZbc"}],"3ieXC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class PaginatiotnView extends _viewDefault.default {
...
exports.default = new PaginatiotnView();

},{"./View":"8rtS4","url:../../img/icons.svg":"iwCpK","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"1r5Cz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"8rtS4","url:../../img/icons.svg":"iwCpK","./previewView":"knRyY","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"4NyJt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class addRecipeView extends _viewDefault.default {
    ...
    _message = 'Recipe was seccessfully uploaded:D';
    constructor(){
        super();
...
},{"./View":"8rtS4","url:../../img/icons.svg":"iwCpK","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["drOo7","jKMjS"], "jKMjS", "parcelRequire6d3a")
